# 🚀 C$K4 Chat v5.2 — Full-Featured Messenger
...
│   ├── admin/
│   │   └── admin.html      # Admin panel UI (dark theme)
...
**Stories:** Top bar me **+** dabao → text/image/video story banao → tags me `@username` add karo → 24h ke baad auto-delete. Dost ki story dekho → progress bar auto-advance (5s). Apni story par 👁 viewers list, ⭐ highlight, delete.
